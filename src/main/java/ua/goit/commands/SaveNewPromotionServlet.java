...
@WebServlet(urlPatterns = "/saveNewPromotion")
public class SaveNewPromotionServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        PromotionDao promotion = promotionConverter.dtoToDao(new PromotionDto(amount, price));
        promotionRepository.save(promotion);
        req.getRequestDispatcher("/WEB-INF/html/promotions/saveNewPromotion.jsp").forward(req, resp);
    }
}
